...
export const baseURL = getEnvVar(
  process.env.BASE_URL,
  import.meta.env?.VITE_AUTH0_BASE_URL,
);

export const newsApiKey = getEnvVar(
...
export const YOUTUBE_API_KEY = getEnvVar(
...
export const secret = getEnvVar(
  process.env.VITE_AUTH0_SECRET,
  import.meta.env?.VITE_AUTH0_SECRET,
);

export const issuerBaseURL = getEnvVar(
...
console.log(
  'Client ID from import.meta.env:',

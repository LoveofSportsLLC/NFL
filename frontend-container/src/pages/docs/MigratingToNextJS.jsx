...
const Intro = () => (
  <div className="mb-5">
    <h3>Introduction</h3>
    <p className="text-lg">
      AppStack React is built using Vite. Follow the steps below to migrate to
      Next.js. Migrating to Next.js allows you to use SSR, API Routes and more.
    </p>
  </div>
);
...
const OfficialGuide = () => (
  <div className="mb-5">
    ...
    <p className="text-lg">
      ...
      . While we're using Vite instead of Create React App, the process and
...
const UpdateEntryFile = () => (
  <div className="mb-5">
    ...
    <p className="text-lg">
      Vite uses the root directory for the entry HTML file (
      <code>/index.html</code>), whereas Next.js uses a custom file (
...
const UpdateRoutes = () => (
  <div className="mb-5">
    ...
    <p className="text-lg">
      With Vite, you're likely using React Router. Instead of using a
      third-party library, Next.js includes its own file-system based routing.
    </p>

            ...
            <section className="">
                <ul className="cardState grid4">
                    ...
                    <li className="card grid2">
                        ...
                        <div className="">
                        <span className="iconClass"><img
                            src="/src/pages/dashboards/Static-Dashboard/images/pending-order.svg"/></span>
                        </div>
                    </li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div className="content">
                            ...
                            <p>Sed aliquam ultrices mauris. Integer ante arcu, accumsan a, consectetuer eget, posuere
                                ut,

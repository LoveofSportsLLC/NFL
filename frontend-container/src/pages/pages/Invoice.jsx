        ...
        <Card>
          <Card.Body className="m-sm-3 m-md-5">
            <div className="mb-4">
              ...
              <br /> This is the receipt for a payment of{' '}
              <strong>$268.00</strong> (USD) you made to AppStack.
            </div>
            ...
            <Row className="mb-4">
              <Col md="6">
                ...
                <p>
                  4183 Forest Avenue <br /> New York City <br /> 10011 <br />{' '}
                  USA <br />

        ...
        children: [
            ...
            children: [
              {
                ...
                children: [
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "QB Passer Rating - Success Rate, Yards per Attempt, Completion Rate",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
                  ...
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "QB Passer Rating & Success Rate by Home vs Away Splits",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "QB: Air Yardage, Yards After Catch & Average Yards to Sticks",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
              ...
              },
              {
                ...
                children: [
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "Directional Rushing: Yards Per Carry & Success by Team & RB",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "Rushing Efficiency: Success Rate Over Average by Direction",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "RB Situational Rushing Yards Per Carry & Success Rates",
                  },
                ],
              },
              {
                ...
                children: [
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "WR Receiving Efficiency: Success Rate Over Average by Direction",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "Receiving: Targets, Passer Rating & Directional Share",
                  },
                ],
              },
              {
                ...
                children: [
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "Situational Success Rate, Run & Pass, Ranked by Team",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
                  ...
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "NFL Offensive Team Ranks: Passing, Rushing & Explosive Plays",
                  },
                ],
              },
              {
              ...
              },
              {
                ...
                children: [
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "NFL Offensive Run & Pass Rate, Frequency by Team and Situation",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "NFL Offensive Target Rate & Frequency by Position & Success Rate",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "NFL Offensive Snap Rates: Shotgun vs Under Center by Run or Pass",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "NFL Run & Pass by Frequency & Successful Plays Called by Situation",
                  },
                  {
                    href: "/form-plugins/advanced-inputs",
                  ...
                  {
                    href: "/form-plugins/advanced-inputs",
                    title: "NFL No Huddle Analysis: Yards Per Play & Success Rate",
                  },
                ],
              },
            ],
          ...
          },
          {
            ...
            children: [
              ...
              {
                href: "/form-plugins/advanced-inputs",
                title: "Offensive Success Rate by Average Yards to Go & Field Position",
              },
            ],
          },
          {
